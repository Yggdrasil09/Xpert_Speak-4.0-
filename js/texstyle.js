$(document).ready(function() {
     ...
     */
    var content = [{
      title:"XpertSpeak.com",
      desc: "XpertSpeak connects world's top professionals with world's best knowledge."
    }, {
      title: "Grow as an Angel Investor",
      desc: "Get access to early and late stage investment opportunities."
    }, {
      title: "Looking for Funds?",
      desc: "Connect with investors and raise capital, quickly, efficiently and at fair terms."
    }, {
      title: "Looking for an Expert?",
      desc: "XpertSpeak connects you to largest network of thought leaders, speakers and learning and development experts across industries and genres."
    }];
    var currentPage = 0;
    //generate content
